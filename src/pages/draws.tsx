...
const Draws = () => {
    ...
    return (
        <Flex direction={"column"} gap={"40px"} width={"100%"} alignItems={"center"}>
            ...
            <Flex gap={"7px"} maxWidth={{base:"90%", md: "50%"}} wrap={"wrap"} justifyContent={"center"}>
            ...
            {lots && lots.length > 0 && <Flex gap={"7px"} bgColor="whitesmoke" rounded={"md"} p={{base: 5, lg: 10}} shadow={"sm"}
